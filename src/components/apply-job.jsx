...
const schema= z.object({
    ...
    .int(),
    skills: z.string().min(1,{message:"Relevant skills are required"}),
    education:z.enum(["Diploma","Graduate","Post Graduate"],{
        message:"Education is required",
    }),
    cgpa: z.string().min(1,{message:"fill your CGPA"})
    .regex(/^\d+(\.\d+)?$/, { message: "CGPA must be a number" }), 
    ...
    <Drawer open={applied?false:undefined}>
        ...
        <DrawerContent>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 p-4 pb-0">
                <Input type="number" placeholder="Years of Experience" className="flex-1" {...register("experience",{
                    valueAsNumber:true,
                })}/>
                {errors.experience && (
                ...
                <Input type="text" placeholder="Current CGPA (out of 10)" className="flex-1" {...register("cgpa")}/>
                {errors.cgpa && (
                ...
                <Button type="submit" variant="blue" sixe="lg">Apply</Button>
