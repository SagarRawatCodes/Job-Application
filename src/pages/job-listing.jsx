...
const JobListing = () => {
  ...
  return(
  <div>
    <h1 className="gradient-title font-extrabold tex-6xl sm:text-7xl text-center pb-8">Latest Jobs</h1>
  ...
  <div className="flex flex-col sm:flex-row gap-2">
    ...
    <Button variant="destructive" className="sm:w-1/2" onClick={clearFilters}>Clear Filters
    </Button>
  </div>

    {loadingJobs &&(
      <BarLoader classNam="mt-4" width={"100%"} color="#36d7b7"/>
    )}
    {loadingJobs===false &&(
